...
- (IBAction)verificationCodeButtonClick:(UIButton *)sender {
    ...
    BLAccount *account = [delegate.let account];
    
    [account sendRegVCode:phoneBody countryCode:phoneHead completionHandler:^(BLBaseResult * _Nonnull result) {
...
- (IBAction)registerButtonClick:(UIButton *)sender {
    ...
    [account regist:phoneBody password:password nickname:nickName vcode:vCode sex:BL_ACCOUNT_MALE birthday:nil countryCode:phoneHead iconPath:nil
